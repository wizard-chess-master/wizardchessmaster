...
- **Castling Fix (Aug 14 2025)**: Fixed kingside castling - king now correctly moves to column 7 (h1/h10) instead of column 6, rook moves to column 6. Updated all castling detection and validation to use correct columns. Queenside castling remains at column 2 (c1/c10) with rook to column 3
