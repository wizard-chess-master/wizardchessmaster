...
const initialLevels: CampaignLevel[] = [
  ...
  // Extended Campaign - New Challenges and Story Arc
  {
    id: 'level13',
    name: 'The Shadow Realm',
    difficulty: 'hard',
    aiStrength: 6,
    description: 'Enter the Shadow Realm where pieces can phase through enemies for one turn after capturing.',
    unlocked: false,
    completed: false,
    attempts: 0,
    wins: 0,
    ...
    boardVariant: 'shadow',
    storyContent: {
      preGameStory: 'Beyond the mortal realm lies shadow. Here, pieces gain ethereal powers after vanquishing foes.',
      postWinStory: 'The shadows have accepted you as their master. The realm between worlds is now yours to command.',
      characterIntroduction: 'The Shadow Keeper watches from the void, testing your ability to think beyond conventional strategy.'
    },
    rewards: { 
      experiencePoints: 700, 
      unlocksStory: true, 
      unlocksBoard: true,
      unlocksBoardVariant: 'shadow'
    }
  },
  {
    id: 'level14',
    name: 'Siege of the Crystal Citadel',
    difficulty: 'advanced',
    aiStrength: 7,
    description: 'Defend your king in a siege scenario - survive 50 moves against relentless attacks.',
    unlocked: false,
    completed: false,
    attempts: 0,
    wins: 0,
    ...
    boardVariant: 'castle',
    storyContent: {
      preGameStory: 'The Crystal Citadel is under siege! Hold the line for 50 moves as waves of enemies assault your position.',
      postWinStory: 'The siege is broken! Your defensive mastery has saved the citadel and earned eternal glory.',
    },
    rewards: { 
  ...
  },
  {
    ...
    difficulty: 'master',
    aiStrength: 8,
    description: 'Battle in a time-warped dimension where captured pieces return after 10 moves.',
    unlocked: false,
    completed: false,
    attempts: 0,
    wins: 0,
    ...
    boardVariant: 'cosmic',
    storyContent: {
      preGameStory: 'Time flows strangely in the Temporal Rift. Defeated pieces phase back into existence, creating endless tactical possibilities.',
      postWinStory: 'You have mastered time itself! The temporal streams bend to your will.',
      characterIntroduction: 'The Chrono Mage manipulates time, bringing fallen warriors back to the battlefield.'
    },
    rewards: { 
      experiencePoints: 1100, 
      unlocksStory: true, 
      unlocksBoard: true,
      unlocksBoardVariant: 'temporal'
    }
  },
  {
    id: 'level16',
    ...
    difficulty: 'master',
    aiStrength: 9,
    description: 'Face the Dragon Lord - wizards gain double teleport range but enemy pieces gain fire attacks.',
    unlocked: false,
    completed: false,
    attempts: 0,
    wins: 0,
    ...
    boardVariant: 'volcanic',
    storyContent: {
      preGameStory: 'The ancient Dragon Lord awakens! Harness enhanced wizard powers to overcome the dragon\'s fiery wrath.',
      postWinStory: 'The Dragon Lord acknowledges your supremacy. Fire and magic now dance at your command.',
    },
    rewards: { 
      experiencePoints: 1300, 
      unlocksStory: true, 
      unlocksBoard: true,
      unlocksBoardVariant: 'dragon'
    }
  },
  {
    id: 'level17',
    ...
    difficulty: 'grandmaster',
    aiStrength: 10,
    description: 'Face a perfect AI mirror of your playing style - it learns and adapts to your every move.',
    unlocked: false,
    completed: false,
    attempts: 0,
    wins: 0,
    ...
    boardVariant: 'mirror',
    storyContent: {
      preGameStory: 'In the Hall of Mirrors, you face your greatest opponent - yourself. The AI has studied your every move.',
      postWinStory: 'You have overcome your own limitations and transcended to a higher level of mastery.',
    },
    rewards: { 
  ...
  {
    id: 'level18',
    name: 'Blitz of the Storm King',
    difficulty: 'grandmaster',
    aiStrength: 10,
    description: 'Speed chess against the Storm King - you have only 5 seconds per move!',
    unlocked: false,
    completed: false,
    attempts: 0,
    wins: 0,
    ...
    boardVariant: 'storm',
    storyContent: {
      preGameStory: 'The Storm King demands swift action! Think fast or be swept away by the tempest.',
      postWinStory: 'Lightning-fast reflexes have earned you the Storm King\'s respect. The winds obey your command.',
    },
    rewards: { 
      experiencePoints: 1400, 
      unlocksStory: true, 
      unlocksBoard: true,
      unlocksBoardVariant: 'storm'
    }
  },
  {
    id: 'level19',
    ...
    difficulty: 'grandmaster',
    aiStrength: 10,
    description: 'Chess in the void - random squares become impassable black holes every 5 moves.',
    unlocked: false,
    completed: false,
    attempts: 0,
    wins: 0,
    ...
    boardVariant: 'void',
    storyContent: {
      preGameStory: 'The Void Walker challenges you in a realm where reality itself collapses. Navigate the ever-changing battlefield.',
      postWinStory: 'You have conquered the void itself! Reality bends to your strategic genius.',
      characterIntroduction: 'The Void Walker exists between dimensions, creating chaos wherever it treads.'
    },
    rewards: { 
      experiencePoints: 1800, 
      unlocksStory: true, 
      unlocksBoard: true,
      unlocksBoardVariant: 'void'
    }
  },
  {
    id: 'level20',
    ...
    difficulty: 'grandmaster',
    aiStrength: 10,
    description: 'The final ascension - defeat three AI opponents simultaneously on a single board!',
    unlocked: false,
    completed: false,
    attempts: 0,
    wins: 0,
    ...
    boardVariant: 'divine',
    storyContent: {
      preGameStory: 'Three divine aspects challenge your ascension. Prove yourself worthy of godhood in the ultimate trial.',
      postWinStory: 'You have ascended! The realm of Wizard Chess recognizes you as its eternal champion and divine master.',
      characterIntroduction: 'The Trinity of Power, Wisdom, and Time unite to test your worthiness for divine ascension.'
    },
    rewards: { 
      experiencePoints: 2500, 
      unlocksStory: true, 
      unlocksBoard: true,
      unlocksBoardVariant: 'divine'
    }
  },
];
